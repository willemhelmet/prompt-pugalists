...
export function placeholderResolve(
  ...
  return {
    ...
    player1ActionChoices: [
      { label: "Power Strike", description: `Launch a powerful attack against ${p2.character.name}!`, category: "attack" as const },
      { label: "Arcane Blast", description: `Unleash a burst of magical energy at ${p2.character.name}.`, category: "magic" as const },
      { label: "Defensive Barrier", description: `Raise a defensive barrier and brace for impact.`, category: "defend" as const },
      { label: "Restorative Focus", description: `Channel inner energy to recover and heal wounds.`, category: "heal" as const },
    ],
    player2ActionChoices: [
      { label: "Power Strike", description: `Launch a powerful attack against ${p1.character.name}!`, category: "attack" as const },
      { label: "Arcane Blast", description: `Unleash a burst of magical energy at ${p1.character.name}.`, category: "magic" as const },
      { label: "Defensive Barrier", description: `Raise a defensive barrier and brace for impact.`, category: "defend" as const },
      { label: "Restorative Focus", description: `Channel inner energy to recover and heal wounds.`, category: "heal" as const },
    ],
    isVictory: false,
